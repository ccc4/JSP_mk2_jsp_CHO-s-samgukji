...
<body data-spy="scroll" data-target="#main-jumbotron">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			%>
				...
				<li class="dropdown">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="uModify_view.jsp">회원정보수정</a></li>
						<li class="divider"></li>
	...
	<div class="container" id="introduce">
		<div id="mainCarousel" class="carousel slide" data-ride="carousel">
			...
			</a> <a class="right carousel-control" href="#mainCarousel" role="button" data-slide="next">
	...
	<div class="container marketing">
		<div class="row">
			<div class="col-lg-4">
				<img class="img-circle" src="images/슈야얼굴.jpg" alt="슈야얼굴" width="140" height="140">
				<h2>
			...
			<div class="col-lg-4">
				<img class="img-circle" src="images/미야얼굴.jpg" alt="미야얼굴" width="140" height="140">
				<h2>
					미야 <span style="font-size: 13px">8월15일생</span>
				</h2>
				<p>
					귀족같은 털을 가진 페르시안이지만 다리가 통통하니 <br>짧은걸로 봐선 먼치킨의 피도 섞여있는것 같다. 집에서 <br>
					제일 이쁨을 받아 가끔 슈야 봄이가 질투를 하는게 <br>느껴진다.
				</p>
			</div>

			<div class="col-lg-4">
				<img class="img-circle" src="images/봄이얼굴.jpg" alt="봄이얼굴" width="140" height="140">
				<h2>
