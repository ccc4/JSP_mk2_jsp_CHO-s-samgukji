	...
	<div class="container">
		...
		<div id="navbar" class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li class="dropdown">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
					<sapn class="glyphicon glyphicon-user active"></sapn></a>
					<ul class="dropdown-menu" role="menu">
		...
		<div class="container">
			<table>
				<form action="uJoin.do" method="post" name="reg_frm">
					...
					<tr>
						<td>성별</td>
						<td><input type="radio" name="userGender" value="1" checked>남자
							&nbsp; <input type="radio" name="userGender" value="0">여자
						</td>
					</tr>
					<tr>
						<td>연락처</td>
						<td>010 - <input type="text" name="userPhone1" maxlength="4">
							- <input type="text" name="userPhone2" maxlength="4">
						</td>
					</tr>
					<tr>
						<td>이메일</td>
						<td><input type="text" name="userEmail1" maxlength="20">
							@ <input type="text" name="userEmail2" maxlength="20"></td>
					</tr>
					<tr>
						<td>주소</td>
